...
def args_parser():
    ...
    parser.add_argument('--dataset', type=str, default='cifar-100', choices=['cifar', 'cifar-100', 'tinyimagenet'],
    ...
    parser.add_argument('--momentum_coefficient', type=float, default=0.85, help="the server momentum_coefficient: λ")
